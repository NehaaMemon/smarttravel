            ...
            <ul class="sidebar-menu" id="sidebar-menu">
                ...
                <li class="dropdown">
                    <a href="javascript:void(0)">
                        ...
                        <span>Blocks detail</span>
                    </a>
                    <ul class="sidebar-submenu">

                        <li>
                            <a href="addblock.php"><i class="ri-circle-fill circle-icon text-primary-main w-auto"></i>Add Tower </a>
                        </li>
                        <li>
                            <a href="invoice-edit.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>Total Tower </a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="invoice-list.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Block A</a>
                        </li>
                        <li>
                            <a href="invoice-preview.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i>Block B</a>
                        </li>
                        <li>
                            <a href="invoice-add.php"><i class="ri-circle-fill circle-icon text-info-main w-auto"></i> Block C</a>
                        </li>
                        <li>
                            <a href="invoice-edit.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>Add Tower </a>
                        </li>
                        <li>
                            <a href="invoice-edit.php"><i class="ri-circle-fill circle-icon text-danger-main w-auto"></i>Total Tower </a>
                        </li>
                ...
                <!-- <li class="sidebar-menu-group-title">Staff Detail</li> -->
                ...
                <li class="dropdown">
                    ...
                    <ul class="sidebar-submenu">
                        <li>
                            <a href="typography.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Security Staff</a>
                        </li>
                        <li>
                            <a href="typography.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i> Cleaning Staff</a>
                        </li>
                        <li>
                            <a href="colors.php"><i class="ri-circle-fill circle-icon text-warning-main w-auto"></i> Reception Staff</a>
                        </li>
                        <li>
                            <a href="button.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Add staff</a>
                        </li>
                        <!-- <li>
